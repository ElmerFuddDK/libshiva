...
CONFIG(debug, debug|release) {
	isEmpty(SHVBUILDFOLDERPREFIX) { SHVBUILDFOLDER = build-debug } else { SHVBUILDFOLDER = build-$${SHVBUILDFOLDERPREFIX}-debug }
} else {
	isEmpty(SHVBUILDFOLDERPREFIX) { SHVBUILDFOLDER = build } else { SHVBUILDFOLDER = build-$${SHVBUILDFOLDERPREFIX} }
}
