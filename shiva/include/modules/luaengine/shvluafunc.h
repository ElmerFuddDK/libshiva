...
public:
	...
	virtual SHVRefObject* ArgAsRef(int idx, const char* typeID = NULL) = 0;
	...
	virtual void PushRef(SHVRefObject* val, const char* typeID = NULL) = 0;
	virtual void PushRef(SHVLuaValues::RefStruct refObj) = 0;
