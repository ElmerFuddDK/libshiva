...
public:
	...
	// from SHVDataEngine
	virtual SHVBool RegisterTable(const SHVDataStructC* dataStruct, SHVDataSession* useSession = NULL, bool strict = false, int flags = FlagNone);
	...
	virtual const SHVDataStructC* ReloadStruct(const SHVString8C& table, SHVDataSession* useSession);
