 ...
 * Constructor
 *************************************/
SHVEventSubscriber::SHVEventSubscriber(SHVEventTarget* target, SHVEventQueue* queue, bool directIfSameThread)
	: Target(target), Queue(queue), DirectIfSameThread(directIfSameThread)
{
}
 ...
 * Perform
 *************************************/
void SHVEventSubscriber::Perform(SHVEvent* event)
{
